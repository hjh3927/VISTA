...
from config import MODEL_TYPE, DEVICE, MIN_AREA, MAX_ERROR, LINE_THRESHOLD, LEARNING_RATE, NUM_ITERS, LAMBDA1, LAMBDA2
...
def main():
    ...
    # 优化 SVG
    svg_optimize(shapes, shape_groups, target_image, DEVICE, OPTIM_SVG_PATH, learning_rate=LEARNING_RATE, num_iters=NUM_ITERS, lamda1=LAMBDA1, lamda2=LAMBDA2)
